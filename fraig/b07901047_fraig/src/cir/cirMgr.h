...
private:
    ...
    void genDFSList();
    void genFltList();
    void runSim(const unsigned cnt);
    void initFEC();
    void updateFEC();
    void genProofModel(SatSolver& s, unordered_map<CirGate*, unsigned>& dfsOrder);
    void collectPattern(SatSolver& s);
    bool proofFecPair(AIGate* g1, AIGate* g2, bool phase, SatSolver& s);
