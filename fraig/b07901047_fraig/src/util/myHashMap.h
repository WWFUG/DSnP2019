...
{
public:
    HashKey(size_t g1, size_t g2): fani1(g1<g2?g1:g2),fani2(g1<g2?g2:g1) {}

    size_t operator() () const {
        int k1 = fani1%((size_t)1<<32);
        int k2 = fani2%((size_t)1<<32);
        return (size_t)((hash(k1)<<32)+hash(k2));    
    } 
    ...
    bool operator == (const HashKey& k) const { return (fani1==k.fani1 && fani2==k.fani2);}
